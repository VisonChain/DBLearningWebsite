    ...
    <div class="container-fluid">
        ...
        <div class="card mb-3">
                    ...
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <c:forEach begin="0" var="resource" items="${resources}" step="1">
                            <tr>
                                ...
                                <td><a href="${contextPath}/ad/resourceDelete/${resource.id}"
            ...
            <div class="card-footer small text-muted">
                <form action="/upload/resUpload" method="post" enctype="multipart/form-data">
                    <input type="file" name="upload_resfile">
                    <input class="btn btn-primary btn-block" type="submit" value="资源上传">
                </form>
            </div>
        </div>
    </div>
