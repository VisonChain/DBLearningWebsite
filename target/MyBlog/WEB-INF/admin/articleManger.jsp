    ...
    <div class="container-fluid">
        ...
        <div class="card mb-3">
                    ...
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <c:forEach begin="0" var="article" items="${articles}" step="1">
                            <tr>
                                ...
                                <td><a href="/ad/update/${article.id}" class="btn btn-success">修改</a></td>
                                <td><a href="/ad/delete/${article.id}" class="btn btn-danger">删除</a></td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
            ...
            <div class="card-footer small text-muted">
                <td><a href="/ad/articleInsert" class="btn btn-primary btn-block">文章内容编辑</a></td>
            </div>
        </div>
    </div>
    <!-- /.container-fluid-->
