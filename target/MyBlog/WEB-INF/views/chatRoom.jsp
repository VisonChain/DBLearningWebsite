...
<head>
    ...
    <!-- UM相关资源 -->
    <link href="<%=contextPath%>/static/assets/umeditor/themes/default/css/umeditor.css" type="text/css"
          rel="stylesheet">
    <script type="text/javascript" charset="utf-8"
            src="<%=contextPath%>/static/assets/umeditor/umeditor.config.js"></script>
    <script type="text/javascript" charset="utf-8"
            src="<%=contextPath%>/static/assets/umeditor/umeditor.min.js"></script>
    <script type="text/javascript" src="<%=contextPath%>/static/assets/umeditor/lang/zh-cn/zh-cn.js"></script>
</head>
<body>
        ...
        <div class="am-u-lg-12" style="height:400px;border:1px solid #999;overflow-y:scroll;">
            <ul id="chatContent" class="am-comments-list am-comments-list-flip">
                <li id="msgtmp" class="am-comment" style="display:none;">
                    <a href="">
                        <img class="am-comment-avatar" src="<%=contextPath%>/static/assets/images/other.jpg" alt=""/>
                    </a>
                    <div class="am-comment-main">
                        <header class="am-comment-hd">
                            <div class="am-comment-meta">
                                <a ff="nickname" href="#link-to-user" class="am-comment-author">神秘人</a>
                                <time ff="msgdate" datetime="" title="">2019-5-12 15:30</time>
                            </div>
                        </header>
...
<script type="text/javascript" language="JavaScript">
    ...
    $(function () {
        ...
        var nickname = document.getElementById("nick").getAttribute("value");
