        ...
        <div class="row">
            <div class="col-lg-8 col-md-10 mx-auto">
                <div class="site-heading">
                    <h1>Professional Newest</h1>
                    <span class="subheading">Cease to struggle and you cease to live.</span>
                </div>
            </div>
        </div>
    </div>
...
<div class="container">
    <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
            ...
            <!-- Pager -->
            <div class="clearfix">
                <a class="btn btn-primary float-right" href="/articlePage">Older Posts &rarr;</a>
            </div>
        </div>
    </div>
</div>
